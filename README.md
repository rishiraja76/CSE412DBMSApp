...
### Clone Repository
  The repository must first be cloned to ease the package dependencies and installation. Additionally, it should be noted that the development of the application was under Pycharm; therefore, to properly run the application without any issues, use the recommended IDE.

To clone the repository, run the following command:

```
$ git clone https://github.com/rishiraja76/CSE412DBMSApp.git
```
